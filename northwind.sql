...
(6, 'Company F', 'Perez-Olaeta', 'Francisco', NULL, 'Purchasing Manager', '(123)555-0100', NULL, NULL, '(123)555-0101', '123 6th Street', 'Milwaukee', 'WI', '99999', 'USA', NULL, NULL, ''),
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `departemen_id` int(11) DEFAULT '4',
  `fullname` varchar(100) NOT NULL,
  `email` varchar(100) DEFAULT NULL,
  `telepon` varchar(30) DEFAULT NULL,
  `nip` varchar(100) DEFAULT NULL,
  `password` varchar(100) DEFAULT '-',
  `userlevels_id` int(11) DEFAULT NULL,
  `proyek` text,
...
INSERT INTO `users` (`id`, `username`, `departemen_id`, `fullname`, `email`, `telepon`, `nip`, `password`, `userlevels_id`, `proyek`, `foto`, `na`) VALUES
(1, 'mardi', 4, 'mardi siswo utomo', 'mardiutomo@gmail.com', '085865349880', NULL, '$2y$10$KpCqXCTL.OGTB8VnzsKV2umDE72K9QRqHfrYHyNDCL9wO4FYgU.MG', -1, NULL, NULL, 'N');
